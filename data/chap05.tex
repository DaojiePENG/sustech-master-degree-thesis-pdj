...
\chapter[RTMQ量子测控系统应用：离子阱频率稳定、激光功率稳定和激光拍频稳定]{RTMQ量子测控系统应用：离子阱频率稳定、激光功率稳定和激光拍频稳定\label{section:implementation}}
...
\subsection[离子阱频率稳定系统搭建]{离子阱频率稳定系统搭建}
...
阱频稳定模块实验测试图如图\ref{fig:trap_frequency_lock_real}所示。
...
\subsection[基于RTMQ的激光功率稳定系统结果]{基于RTMQ的激光功率稳定系统结果}
...
\subsection[脉冲激光拍频系统稳定结果]{脉冲激光拍频系统稳定结果}
